...
namespace MISL.Ababil.Agent.UI.forms
{
    public partial class frmIndividualInformation : Form
    {
        ...
        private bool validationCheck()
        {
            ...
            //{
            //    Message.showWarning("Spouse name not found.");
            //    return false;
            //}
            try
            {
            ...
            {
                Message.showWarning("Individual first name not found.");
                return false;
            }
            if (_individualInformation.lastName == "")
            {
                Message.showWarning("Individual last name not found.");
                return false;
            }
            if (_individualInformation.fatherFirstName == "")
            {
                Message.showWarning("Father first name not found.");
                return false;
            }
            if (_individualInformation.fatherLastName == "")
            {
                Message.showWarning("Father last name not found.");
                return false;
            }
            if (_individualInformation.motherFirstName == "")
            {
                Message.showWarning("Mother first name not found.");
                return false;
            }
            if (_individualInformation.motherLastName == "")
            {
                Message.showWarning("Mother last name not found.");
                return false;
            }
            if (_individualInformation.gender.ToString() == "")
            {
                Message.showWarning("Gender not found.");
                return false;
            }
            if (_individualInformation.maritalStatus.ToString() == "")
            {
                Message.showWarning("Marital status not found.");
                return false;
            }
            if (_individualInformation.maritalStatus == MaritalStatus.Married && _individualInformation.spouseName == "")
            {
            ...
            */
            ...
            {
                Message.showWarning("Birth country not found.");
                return false;
            }
            ...
            if (_individualInformation.occupation == null)
            {
                Message.showWarning("Occupation not found.");
                return false;
            }
            ...
            if (_individualInformation.presentAddress == null)
            {
                Message.showWarning("Present address not found.");
                return false;
            }
            else
            {
            ...
            if (_individualInformation.permanentAddress == null)
            {
                Message.showWarning("PermanentAddress address not found.");
                return false;
            }
            else
            {
