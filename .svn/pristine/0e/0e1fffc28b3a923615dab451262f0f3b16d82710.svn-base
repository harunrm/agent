...
class InputDialog : Form
{
    ...
    protected WaterMarkTextBox txtInput;
    ...
    private InputDialog()
    {
        ...
        lblMessage.Font = new Font("Segoe UI", 15);
        ...
        this.txtInput.WaterMarkColor = System.Drawing.Color.Gray;
        this.txtInput.WaterMarkText = "Leave your remarks here";
    ...
    {
        WaterMarkTextBox txt = (WaterMarkTextBox)sender;
