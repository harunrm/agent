...
{
    public partial class frmChequeDeliveryReport : MetroForm
    {
        ...
        public frmChequeDeliveryReport()
        {
            InitializeComponent();
        ...
        private void LoadSetupData()
        {
            try
            {
                ...
                cmbStatus.SelectedValue = ChequeRequisitionStatus.Delivered.ToString();
        ...
        private List<ChequeRequisitionReportResultDto> LoadChequeRequisitionRegisterData()
        {
            ...
            try
            {
                chqRequisitionReportResult = service.getChequeDeliveryReport(requisitionReportSearchDto);
                ...
                if (chqRequisitionReportResult != null)
                {
                    foreach (ChequeRequisitionReportResultDto chqRecord in chqRequisitionReportResult)
                    {
                            ...
                            chqRequisitionRow.endingNo = chqRecord.endingNo;
                            chqRequisitionRow.startingNo = chqRecord.startingNo;
        ...
        private void btnShowReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rptHeaders = UtilityServices.getReportHeaders("Cheque Delivery Information");
               ...
               {
                   txtDeliveryFrom.Text = "Delivered From";
               }
                else txtDeliveryFrom.Text = "Request From";
